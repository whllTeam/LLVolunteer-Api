...
namespace UploadFileEx
{
    public static class FileStreamingHelper
    {
        ...
        /// <returns></returns>
        public static async Task<string[]> StreamFiles(this HttpRequest request, string targetDirectory)
        {
                ...
                if (hasContentDispositionHeader)
                {
                    ...
                    */
                    if (MultipartRequestHelper.HasFileContentDisposition(contentDisposition))
                    {
                        ...
                        filePath = $"{targetDirectory}\\{Guid.NewGuid().ToString()}{Path.GetExtension(string.Copy(fileName))}";
